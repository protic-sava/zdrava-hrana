...
/* Breadcrumb Begin */
function vw_health_coaching_the_breadcrumb() {
	if (!is_home()) {
		echo '<a href="';
...
function vw_health_coaching_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Footer Social Icon', 'vw-health-coaching' ),
		'description'   => __( 'Appears on right side footer', 'vw-health-coaching' ),
		'id'            => 'footer-icon',
...
function vw_health_coaching_scripts() {
	...
	wp_enqueue_script( 'vw-health-coaching-custom-scripts', get_template_directory_uri() . '/assets/js/custom.js', array('jquery') );

	if (get_theme_mod('vw_health_coaching_animation', true) == true){
...
define('VW_HEALTH_COACHING_FREE_THEME_DOC',__('https://preview.vwthemesdemo.com/docs/free-vw-health-coach/','vw-health-coaching'));
...
define('VW_HEALTH_COACHING_PRO_DOC',__('https://preview.vwthemesdemo.com/docs/vw-health-coach-pro/','vw-health-coaching'));
...
if ( ! defined( 'VW_HEALTH_COACHING_GETSTARTED_URL' ) ) {
	define( 'VW_HEALTH_COACHING_GETSTARTED_URL', 'themes.php?page=vw_health_coaching_guide');
}

if ( ! defined( 'VW_HEALTH_COACHING_GO_PRO' ) ) {
	define( 'VW_HEALTH_COACHING_GO_PRO', 'https://www.vwthemes.com/themes/health-coaching-wordpress-theme/');
}
...
function vw_health_coaching_tagline_hide_show(){
	if(get_theme_mod('vw_health_coaching_tagline_hide_show', 0) == '1' ) {
		return true;
	}
	return false;
}
...
//Active Callback
function vw_health_coaching_default_slider(){
	if(get_theme_mod('vw_health_coaching_slider_type', 'Default slider') == 'Default slider' ) {
		return true;
	}
	return false;
}

function vw_health_coaching_advance_slider(){
	if(get_theme_mod('vw_health_coaching_slider_type', 'Default slider') == 'Advance slider' ) {
		return true;
	}
	return false;
}

function vw_health_coaching_blog_post_featured_image_dimension(){
	if(get_theme_mod('vw_health_coaching_blog_post_featured_image_dimension') == 'custom' ) {
		return true;
	}
	return false; 
}
