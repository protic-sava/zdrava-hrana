        ...
        <div class="entry-attachment">
            ...
            <?php if ( has_excerpt() ) : ?>
                <div class="entry-caption">
                    <div class="entry-content"><p><?php $vw_health_coaching_excerpt = get_the_excerpt(); echo esc_html( vw_health_coaching_string_limit_words( $vw_health_coaching_excerpt, esc_attr(get_theme_mod('vw_health_coaching_excerpt_number','30')))); ?></p></div>
                </div>
            <?php endif; ?>
        </div>    
        <?php
