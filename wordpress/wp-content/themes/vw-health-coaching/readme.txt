...
= 0.6 =
* Added slider and services button text option in customizer.
...
= 1.1 =
* Remove preloader default Color.
* Added css for wocommerce pages.
* Changed blog page icons.
...
= 1.1.3 =
* Added go pro button in footer and service in customizer.
...
* Added default button text in service section.
* Update language folder.
...
* Added show/hide blog post date, time, comment and author option in customizer.
...
VW Health Coaching WordPress Theme, Copyright 2018 VWthemes
VW Health Coaching is distributed under the terms of the GNU GPL.
...
* Stocksnap Images
  ...
  Header Image, Copyright Tikkho Maciel
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://stocksnap.io/photo/6X9WTXG24A

* All the icons taken from genericons licensed under GPL License.
http://genericons.com/

== Theme Documentation ==
Documentation : https://preview.vwthemesdemo.com/docs/free-vw-health-coach/
